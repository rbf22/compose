...
from .php import UTF8StringToArray, UTF8ToUTF16BE, sprintf, substr
from .py3k import PY3K, BytesIO, Image, b, basestring, exception, hashpath, pickle, unicode, urlopen
...
def load_cache(filename):
    ...
    except (OSError, ValueError):  # File missing, unsupported pickle, etc
        return None
