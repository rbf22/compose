...
def default(value: Any | None, fallback: Any) -> Any:
...
def deflt(value: Any | None, fallback: Any) -> Any:
...
def _single_child(node: ParseNode) -> ParseNode | None:
    body = node.get("body")
...
def assert_non_null(value: Any | None) -> Any:
...
def protocol_from_url(url: str) -> str | None:
