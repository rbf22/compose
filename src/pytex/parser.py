...
from .unicode_sup_or_sub import U_SUBS_AND_SUPS, UNICODE_SUB_REGEX
from .unicode_symbols import UNICODE_SYMBOLS
from .units import valid_unit

try:
    from .symbols_data_generated import ATOMS
    from .symbols_data_generated import symbols as SYMBOLS
except ImportError:
    SYMBOLS = {}
    ATOMS = {}
...
class Parser:
    ...
    def parse_expression(
        self,
        break_on_infix: bool,
        break_on_token_text: str | None = None,
    ) -> list[Any]:
    ...
    def parse_atom(self, break_on_token_text: str | None = None) -> Any | None:
    ...
    def parse_arguments(
        ...
        def _type_name(spec: FunctionSpec | dict[str, Any]) -> str | None:
    ...
    def parse_color_group(self, optional: bool) -> dict[str, Any] | None:
    ...
    def parse_argument_group(self, optional: bool, mode: Mode | None = None) -> dict[str, Any] | None:
    ...
    def parse_size_group(self, optional: bool) -> Any | None:
    ...
    def parse_url_group(self, optional: bool) -> Any | None:
