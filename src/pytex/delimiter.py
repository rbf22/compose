...
def get_metrics(symbol: str, font: str, mode: Mode) -> dict[str, float] | None:
...
def make_sqrt_image(height: float, options: Options) -> dict[str, SvgSpan | float]:
