...
DELIMITER_SIZES: dict[str, dict[str, str | int]] = {
...
def _ensure_mode(mode_value: str | Mode | None) -> Mode:
...
def _middle_html_builder(group: ParseNode, options: Options) -> Any:
    ...
    if middle_group["delim"] == ".":
        ...
        middle_delim.is_middle = {"delim": middle_group["delim"], "options": options}
