...
from ..utils import get_base_elem, is_character_box
...
def html_builder(group: ParseNode, options: Options) -> Any:
    ...
    base_node_opt: AnyParseNode | None = None
    ...
    if (isinstance(group, dict) and group_dict.get("type") == "supsub" and
        ...
        accent_dict = group_dict
        base_node_opt = cast(AnyParseNode | None, accent_dict.get("base"))
    ...
    if not is_stretchy:
        ...
        if label == "\\vec":
            ...
            symbol_node: SymbolNode | None = None
        else:
        ...
        wrapper_style: dict[str, str] | None = None
        if skew > 0:
            wrapper_style = {
