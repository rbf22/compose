...
class EnvDefSpec:
    ...
    html_builder: HtmlBuilder | None
    mathml_builder: MathMLBuilder | None
...
def _coerce_env_spec(spec: EnvDefSpec | dict[str, Any]) -> EnvDefSpec:
...
def define_environment(spec: EnvDefSpec | dict[str, Any]) -> None:
