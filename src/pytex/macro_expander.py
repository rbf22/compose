...
class MacroExpander:
    ...
    def scan_argument(self, is_optional: bool) -> Token | None:
    ...
    def consume_arg(self, delims: list[str] | None = None) -> MacroArg:
    ...
    def consume_args(self, num_args: int, delimiters: list[list[str]] | None = None) -> list[list[Token]]:
        ...
        for i in range(num_args):
            arg_delims: list[str] | None = delimiters[i + 1] if delimiters else None
    ...
    def expand_once(self, expandable_only: bool = False) -> int | bool:
    ...
    def expand_macro(self, name: str) -> list[Token] | None:
    ...
    def expand_macro_as_text(self, name: str) -> str | None:
    ...
    def _get_expansion(self, name: str) -> MacroExpansion | None:
        ...
        return cast(MacroExpansion | None, expansion)
