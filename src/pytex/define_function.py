...
FunctionHandler = Callable[[FunctionContext, list[Any], list[Any | None]], Any]
...
class FunctionPropSpec:
    ...
    allowed_in_math: bool | None = True
...
class FunctionDefSpec:
    ...
    mathml_builder: MathMLBuilder | None = None
...
def _coerce_function_def(spec: FunctionDefSpec | dict[str, Any]) -> FunctionDefSpec:
...
def define_function(spec: FunctionDefSpec | dict[str, Any]) -> None:
    print(f"[DEBUG] define_function called with spec type: {type(spec)}")
