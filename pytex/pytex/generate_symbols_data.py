...
def _parse_js_string_literal(src: str) -> Optional[str]:
...
def _parse_symbols_js(src_text: str) -> Dict[str, Dict[str, Dict[str, Optional[str]]]]:
    ...
    symbols: Dict[str, Dict[str, Dict[str, Optional[str]]]] = {
        "math": {},
        "text": {},
    }
...
def _add_loop_built_symbols(symbols: Dict[str, Dict[str, Dict[str, Optional[str]]]]) -> None:
...
def _normalise_symbols(symbols: Dict[str, Dict[str, Dict[str, Optional[str]]]]) -> Dict[str, Dict[str, Dict[str, Optional[str]]]]:
    """Return a copy of *symbols* with modes and keys sorted for stability."""

    normalised: Dict[str, Dict[str, Dict[str, Optional[str]]]] = {}
