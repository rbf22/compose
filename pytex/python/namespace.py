...
class Namespace(Generic[Value]):
    ...
    def __init__(
        self,
        builtins: Optional[Dict[str, Value]] = None,
        global_macros: Optional[Dict[str, Value]] = None
    ):
        self.current: Dict[str, Value] = global_macros or {}
        self.builtins: Dict[str, Value] = builtins or {}
        self.undef_stack: List[Dict[str, Optional[Value]]] = []
    ...
    def set(self, name: str, value: Optional[Value], global_: bool = False) -> None:
